...
implements Runnable, Callable<Object>, Disposable {
    ...
    public void run() {
        ...
        try {
            try {
                System.out.println("ScheduledRunnable---->run start: actual class:"+actual.getClass().getName());
                actual.run();
                System.out.println("ScheduledRunnable---->run end");
            } catch (Throwable e) {
                // Exceptions.throwIfFatal(e); nowhere to go
                System.out.println("ScheduledRunnable---->run throw error");
